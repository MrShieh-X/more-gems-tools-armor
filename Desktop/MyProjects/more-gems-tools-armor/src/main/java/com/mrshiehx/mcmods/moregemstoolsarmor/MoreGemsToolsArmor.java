...
public class MoreGemsToolsArmor implements ModInitializer {
	...
	public void onInitialize() {
		...
		Registry.register(Registry.ITEM, new Identifier(MGTAVariables.modid, "yellow_gem"),yellowGem);Registry.register(Registry.BLOCK, new Identifier(MGTAVariables.modid, "sapphire_block"), sapphireBlock);
