...
public class MoreGemsToolsArmor implements ModInitializer {
	...
	public static final BlockEntityType<ItemUpgradeTableBlockEntity> itemUpgradeTableEntity = BlockEntityType.Builder.create(ItemUpgradeTableBlockEntity::new, itemUpgradeTable).build(null);
	...
	public static Identifier id(String path) {
		return new Identifier(MGTAStrings.modid, path);
	}
	...
	public void onInitialize() {
		LOGGER.info("More Gems Tools Armor version is "+MGTAStrings.version+", Minecraft version is "+MGTAStrings.mcVersion);
		//og115();
		og116();
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "sapphire"),sapphire);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "brown_gem"),brownGem);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "purple_gem"),purpleGem);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "ruby"),ruby);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "yellow_gem"),yellowGem);Registry.register(Registry.BLOCK, new Identifier(MGTAStrings.modid, "sapphire_block"), sapphireBlock);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "sapphire_block"), new BlockItem(sapphireBlock, new Item.Settings().group(MoreGemsToolsArmor.MOREGEMSTOOLSARMOR_GROUP)));
		Registry.register(Registry.BLOCK, new Identifier(MGTAStrings.modid, "brown_gem_block"), brownGemBlock);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "brown_gem_block"), new BlockItem(brownGemBlock, new Item.Settings().group(MoreGemsToolsArmor.MOREGEMSTOOLSARMOR_GROUP)));
		Registry.register(Registry.BLOCK, new Identifier(MGTAStrings.modid, "purple_gem_block"), purpleGemBlock);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "purple_gem_block"), new BlockItem(purpleGemBlock, new Item.Settings().group(MoreGemsToolsArmor.MOREGEMSTOOLSARMOR_GROUP)));
		Registry.register(Registry.BLOCK, new Identifier(MGTAStrings.modid, "ruby_block"), rubyBlock);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "ruby_block"), new BlockItem(rubyBlock, new Item.Settings().group(MoreGemsToolsArmor.MOREGEMSTOOLSARMOR_GROUP)));
		Registry.register(Registry.BLOCK, new Identifier(MGTAStrings.modid, "yellow_gem_block"), yellowGemBlock);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "yellow_gem_block"), new BlockItem(yellowGemBlock, new Item.Settings().group(MoreGemsToolsArmor.MOREGEMSTOOLSARMOR_GROUP)));
		Registry.register(Registry.BLOCK, new Identifier(MGTAStrings.modid, "sapphire_ore"), sapphireOre);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "sapphire_ore"), new BlockItem(sapphireOre, new Item.Settings().group(MoreGemsToolsArmor.MOREGEMSTOOLSARMOR_GROUP)));
		Registry.register(Registry.BLOCK, new Identifier(MGTAStrings.modid, "brown_gem_ore"), brownGemOre);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "brown_gem_ore"), new BlockItem(brownGemOre, new Item.Settings().group(MoreGemsToolsArmor.MOREGEMSTOOLSARMOR_GROUP)));
		Registry.register(Registry.BLOCK, new Identifier(MGTAStrings.modid, "purple_gem_ore"), purpleGemOre);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "purple_gem_ore"), new BlockItem(purpleGemOre, new Item.Settings().group(MoreGemsToolsArmor.MOREGEMSTOOLSARMOR_GROUP)));
		Registry.register(Registry.BLOCK, new Identifier(MGTAStrings.modid, "ruby_ore"), rubyOre);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "ruby_ore"), new BlockItem(rubyOre, new Item.Settings().group(MoreGemsToolsArmor.MOREGEMSTOOLSARMOR_GROUP)));
		Registry.register(Registry.BLOCK, new Identifier(MGTAStrings.modid, "yellow_gem_ore"), yellowGemOre);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "yellow_gem_ore"), new BlockItem(yellowGemOre, new Item.Settings().group(MoreGemsToolsArmor.MOREGEMSTOOLSARMOR_GROUP)));
		Registry.register(Registry.BLOCK, new Identifier(MGTAStrings.modid, "stone_of_experience"), stoneOfExperience);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "stone_of_experience"), new BlockItem(stoneOfExperience, new Item.Settings().group(MoreGemsToolsArmor.MOREGEMSTOOLSARMOR_GROUP)));
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "sapphire_helmet"),sapphireHelmet);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "sapphire_chestplate"),sapphireChestplate);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "sapphire_leggings"),sapphireLeggings);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "sapphire_boots"),sapphireBoots);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "brown_gem_helmet"),brownGemHelmet);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "brown_gem_chestplate"),brownGemChestplate);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "brown_gem_leggings"),brownGemLeggings);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "brown_gem_boots"),brownGemBoots);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "purple_gem_helmet"),purpleGemHelmet);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "purple_gem_chestplate"),purpleGemChestplate);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "purple_gem_leggings"),purpleGemLeggings);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "purple_gem_boots"),purpleGemBoots);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "ruby_helmet"),rubyHelmet);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "ruby_chestplate"),rubyChestplate);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "ruby_leggings"),rubyLeggings);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "ruby_boots"),rubyBoots);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "yellow_gem_helmet"),yellowGemHelmet);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "yellow_gem_chestplate"),yellowGemChestplate);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "yellow_gem_leggings"),yellowGemLeggings);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "yellow_gem_boots"),yellowGemBoots);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "emerald_helmet"),emeraldHelmet);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "emerald_chestplate"),emeraldChestplate);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "emerald_leggings"),emeraldLeggings);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "emerald_boots"),emeraldBoots);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "sapphire_sword"),sapphireSword);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "brown_gem_sword"),brownGemSword);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "purple_gem_sword"),purpleGemSword);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "ruby_sword"),rubySword);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "yellow_gem_sword"),yellowGemSword);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "emerald_sword"),emeraldSword);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "sapphire_shovel"),sapphireShovel);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "brown_gem_shovel"),brownGemShovel);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "purple_gem_shovel"),purpleGemShovel);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "ruby_shovel"),rubyShovel);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "yellow_gem_shovel"),yellowGemShovel);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "emerald_shovel"),emeraldShovel);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "sapphire_pickaxe"),sapphirePickaxe);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "brown_gem_pickaxe"),brownGemPickaxe);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "purple_gem_pickaxe"),purpleGemPickaxe);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "ruby_pickaxe"),rubyPickaxe);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "yellow_gem_pickaxe"),yellowGemPickaxe);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "emerald_pickaxe"),emeraldPickaxe);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "sapphire_axe"),sapphireAxe);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "brown_gem_axe"),brownGemAxe);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "purple_gem_axe"),purpleGemAxe);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "ruby_axe"),rubyAxe);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "yellow_gem_axe"),yellowGemAxe);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "emerald_axe"),emeraldAxe);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "sapphire_hoe"),sapphireHoe);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "brown_gem_hoe"),brownGemHoe);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "purple_gem_hoe"),purpleGemHoe);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "ruby_hoe"),rubyHoe);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "yellow_gem_hoe"),yellowGemHoe);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "emerald_hoe"),emeraldHoe);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "diamond_apple"),diamondApple);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "iron_apple"),ironApple);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "emerald_apple"),emeraldApple);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "sapphire_apple"),sapphireApple);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "brown_gem_apple"),brownGemApple);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "purple_gem_apple"),purpleGemApple);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "ruby_apple"),rubyApple);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "yellow_gem_apple"),yellowGemApple);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "quartz_apple"),quartzApple);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "netherite_apple"),netheriteApple);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "enchanted_diamond_apple"),enchantedDiamondApple);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "enchanted_iron_apple"),enchantedIronApple);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "enchanted_emerald_apple"),enchantedEmeraldApple);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "enchanted_sapphire_apple"),enchantedSapphireApple);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "enchanted_brown_gem_apple"),enchantedBrownGemApple);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "enchanted_purple_gem_apple"),enchantedPurpleGemApple);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "enchanted_ruby_apple"),enchantedRubyApple);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "enchanted_yellow_gem_apple"),enchantedYellowGemApple);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "enchanted_quartz_apple"),enchantedQuartzApple);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "enchanted_netherite_apple"),enchantedNetheriteApple);

		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "mixed_gem_sword"),mixedGemSword);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "mixed_gem_shovel"),mixedGemShovel);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "mixed_gem_pickaxe"),mixedGemPickaxe);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "mixed_gem_axe"),mixedGemAxe);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "mixed_gem_hoe"),mixedGemHoe);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "mixed_gem_helmet"),mixedGemHelmet);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "mixed_gem_chestplate"), mixedGemChestplate);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "mixed_gem_leggings"),mixedGemLeggings);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "mixed_gem_boots"),mixedGemBoots);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "mixed_gem_apple"),mixedGemApple);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "enchanted_mixed_gem_apple"),enchantedMixedGemApple);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_sapphire_helmet"),upgradedSapphireHelmet);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_sapphire_chestplate"),upgradedSapphireChestplate);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_sapphire_leggings"),upgradedSapphireLeggings);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_sapphire_boots"),upgradedSapphireBoots);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_brown_gem_helmet"),upgradedBrownGemHelmet);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_brown_gem_chestplate"),upgradedBrownGemChestplate);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_brown_gem_leggings"),upgradedBrownGemLeggings);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_brown_gem_boots"),upgradedBrownGemBoots);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_purple_gem_helmet"),upgradedPurpleGemHelmet);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_purple_gem_chestplate"),upgradedPurpleGemChestplate);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_purple_gem_leggings"),upgradedPurpleGemLeggings);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_purple_gem_boots"),upgradedPurpleGemBoots);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_ruby_helmet"),upgradedRubyHelmet);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_ruby_chestplate"),upgradedRubyChestplate);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_ruby_leggings"),upgradedRubyLeggings);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_ruby_boots"),upgradedRubyBoots);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_yellow_gem_helmet"),upgradedYellowGemHelmet);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_yellow_gem_chestplate"),upgradedYellowGemChestplate);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_yellow_gem_leggings"),upgradedYellowGemLeggings);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_yellow_gem_boots"),upgradedYellowGemBoots);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_emerald_helmet"),upgradedEmeraldHelmet);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_emerald_chestplate"),upgradedEmeraldChestplate);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_emerald_leggings"),upgradedEmeraldLeggings);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_emerald_boots"),upgradedEmeraldBoots);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_sapphire_sword"),upgradedSapphireSword);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_brown_gem_sword"),upgradedBrownGemSword);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_purple_gem_sword"),upgradedPurpleGemSword);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_ruby_sword"),upgradedRubySword);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_yellow_gem_sword"),upgradedYellowGemSword);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_emerald_sword"),upgradedEmeraldSword);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_sapphire_shovel"),upgradedSapphireShovel);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_brown_gem_shovel"),upgradedBrownGemShovel);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_purple_gem_shovel"),upgradedPurpleGemShovel);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_ruby_shovel"),upgradedRubyShovel);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_yellow_gem_shovel"),upgradedYellowGemShovel);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_emerald_shovel"),upgradedEmeraldShovel);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_sapphire_pickaxe"),upgradedSapphirePickaxe);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_brown_gem_pickaxe"),upgradedBrownGemPickaxe);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_purple_gem_pickaxe"),upgradedPurpleGemPickaxe);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_ruby_pickaxe"),upgradedRubyPickaxe);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_yellow_gem_pickaxe"),upgradedYellowGemPickaxe);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_emerald_pickaxe"),upgradedEmeraldPickaxe);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_sapphire_axe"),upgradedSapphireAxe);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_brown_gem_axe"),upgradedBrownGemAxe);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_purple_gem_axe"),upgradedPurpleGemAxe);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_ruby_axe"),upgradedRubyAxe);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_yellow_gem_axe"),upgradedYellowGemAxe);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_emerald_axe"),upgradedEmeraldAxe);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_sapphire_hoe"),upgradedSapphireHoe);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_brown_gem_hoe"),upgradedBrownGemHoe);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_purple_gem_hoe"),upgradedPurpleGemHoe);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_ruby_hoe"),upgradedRubyHoe);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_yellow_gem_hoe"),upgradedYellowGemHoe);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_emerald_hoe"),upgradedEmeraldHoe);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_mixed_gem_sword"),upgradedMixedGemSword);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_mixed_gem_shovel"),upgradedMixedGemShovel);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_mixed_gem_pickaxe"),upgradedMixedGemPickaxe);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_mixed_gem_axe"),upgradedMixedGemAxe);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_mixed_gem_hoe"),upgradedMixedGemHoe);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_mixed_gem_helmet"),upgradedMixedGemHelmet);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_mixed_gem_chestplate"),upgradedMixedGemChestplate);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_mixed_gem_leggings"),upgradedMixedGemLeggings);
		Registry.register(Registry.ITEM, new Identifier(MGTAStrings.modid, "upgraded_mixed_gem_boots"),upgradedMixedGemBoots);
		...
		Registry.register(Registry.BLOCK_ENTITY_TYPE, id("item_upgrade_table"), itemUpgradeTableEntity);
...
*/
	...
	public void og116(){
		Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, new Identifier(MGTAStrings.modid, "ore_brown_gem_ore"), ORE_BROWN_GEM_ORE);
		Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, new Identifier(MGTAStrings.modid, "ore_purple_gem_ore"), ORE_PURPLE_GEM_ORE);
		Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, new Identifier(MGTAStrings.modid, "ore_sapphire_ore"), ORE_SAPPHIRE_ORE);
		Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, new Identifier(MGTAStrings.modid, "ore_ruby_ore"), ORE_RUBY_ORE);
		Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, new Identifier(MGTAStrings.modid, "ore_yellow_gem_ore"), ORE_YELLOW_GEM_ORE);
		Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, new Identifier(MGTAStrings.modid, "ore_stone_of_experience"), ORE_STONE_OF_EXPERIENCE);
