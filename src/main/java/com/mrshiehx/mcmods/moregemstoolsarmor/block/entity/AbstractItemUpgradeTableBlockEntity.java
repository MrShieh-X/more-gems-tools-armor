...
public abstract class AbstractItemUpgradeTableBlockEntity extends LockableContainerBlockEntity implements SidedInventory, RecipeUnlocker, RecipeInputProvider, Tickable {
   ...
   protected AbstractItemUpgradeTableBlockEntity(BlockEntityType<?> blockEntityType, RecipeType<? extends AbstractCookingRecipe> recipeType) {
      ...
      this.propertyDelegate = new PropertyDelegate() {
         public int get(int index) {
            ...
            case 2:
               return AbstractItemUpgradeTableBlockEntity.this.cookTime;
            case 3:
               return AbstractItemUpgradeTableBlockEntity.this.cookTimeTotal;
            default:
               return 0;
            }
         }
         ...
         public void set(int index, int value) {
            ...
            case 1:
               ...
               break;
            case 2:
               AbstractItemUpgradeTableBlockEntity.this.cookTime = value;
               break;
            case 3:
               AbstractItemUpgradeTableBlockEntity.this.cookTimeTotal = value;
            }
